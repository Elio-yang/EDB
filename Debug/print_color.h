/*
 * Debug/print_color.h
 * a set code used for *printf
 * possible usage:
 * printf("\033[<背景颜色>;<字体颜色>m<待打印字符串>\033[0m");
 *
 * @author Elio Yang
...
#ifndef MY_DATABASE_PRINT_COLOR_H
#define MY_DATABASE_PRINT_COLOR_H
 ...
 */
#endif //MY_DATABASE_PRINT_COLOR_H
